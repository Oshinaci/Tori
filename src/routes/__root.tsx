...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tori — Crypto as Easy as GoPay" },
      {
        name: "description",
        content:
          "Tori is the everyday crypto wallet. Send, receive, swap, bridge, and buy crypto across every major chain with a beautiful, secure, self-custody experience.",
      },
      { name: "author", content: "Tori" },
      { property: "og:title", content: "Tori — Crypto as Easy as GoPay" },
      {
