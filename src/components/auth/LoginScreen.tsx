...
import { Mail, Lock, Loader2, ArrowRight, XCircle, AlertCircle } from "lucide-react";
...
export function LoginScreen() {
  ...
  return (
    <AuthLayout
      title="Welcome Back"
      subtitle="Sign in to your Tori Wallet using your registered credentials."
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        {errorMessage && (
          <div className="space-y-2 rounded-2xl bg-red-500/15 p-3.5 text-xs text-red-300 border border-red-500/30">
            ...
            {isUnverified && (
              <div className="pt-2 border-t border-red-500/20 flex justify-end">
                ...
                >
                  ...
                  <span>Verify Email OTP Now</span>
                </Link>
              </div>
            )}
          </div>
